...
<?php global $bur_ranks ;?>
	...
	<?php echo '<input name="'.$item10.'" id="'.$item10.'" type="checkbox" value="1" class="code" ' . checked( 1,$value10, false ) . ' /> Show the rank name superimposed on the image';
 	?>
	</td>
	</tr>
